...
#   --- コールバックの連鎖を前提としている
# - --- MATCHセレクタはキーが一致したコンポーネントで選択された要素をコールバックで利用する


# ＜実行＞
# conda activate plotly-dash-book
# python .\practice\ch07_dash_callback\7-2-2_Matchセレクタ_1.py
...
# - ドロップダウンの更新を検知してindexキーの選択された要素(Match)を取得してリスト表示する
